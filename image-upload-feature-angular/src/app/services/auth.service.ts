...
import { ChangePasswordRequest, ChangePasswordResponse, LoginRequest, PasswordResetRequest, ResendEmail, Token, TokenPayload, User, UserRequest, UserResponse, UserRole, VerifyData } from '../models/auth.model';
...
export class AuthService {
  ...
  saveCredentials(email: string, password: string) {
    if (isPlatformBrowser(this.platformId)) {
      localStorage.setItem('ImageStorageEmail', email);
      localStorage.setItem('ImageStoragePass', password);
    }
  }
  ...
  private clearAuthData(): void {
    ...
    if (isPlatformBrowser(this.platformId)) {
      ...
      localStorage.removeItem('ImageStorageEmail');
      localStorage.removeItem('ImageStoragePass');
    }
  }
